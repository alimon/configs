...
pkg_list="android-tools-fsutils chrpath cpio diffstat gawk libmagickwand-dev libmath-prime-util-perl libsdl1.2-dev libssl-dev python-requests texinfo whiptail"
...
case "${MACHINE}" in
  juno)
    # FIXME: Juno has several dtb files
    ;;
  *)
