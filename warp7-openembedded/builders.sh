...
#RMH KERNEL_IMAGE_BASE_NAME_append = "-${BUILD_NUMBER}"
#RMH MODULE_IMAGE_BASE_NAME_append = "-${BUILD_NUMBER}"
#RMH DT_IMAGE_BASE_NAME_append = "-${BUILD_NUMBER}"
#RMH BOOT_IMAGE_BASE_NAME_append = "-${BUILD_NUMBER}"
#RMH EOF
...
DISK_IMG=$(find ${DEPLOY_DIR_IMAGE} -type f -name "*-${MACHINE}-*-${BUILD_NUMBER}.rootfs.wic.gz" | xargs -r basename)
